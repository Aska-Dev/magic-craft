summon item ~ ~ ~ {Tags:["craft"],Item:{id:"minecraft:iron_axe",Count:1b,tag:{display:{Name:'{"text":"Divine Axe","color":"white","italic":false}'},HideFlags:1,CustomModelData:1680020,divineaxe:1b,Enchantments:[{id:"minecraft:efficiency",lvl:1s},{id:"minecraft:unbreaking",lvl:1s}]}}}
